...
class Nail711 extends HtmlParser
{
    const URL    = 'https://w.tw.mawebcenters.com/salin/ecommerce/';
    const URI    = 'https://w.tw.mawebcenters.com/salin/ecommerce/catalogsearch/result/index/?mode=list&q={search_text}';
    const METHOD = 'GET';
    const NAME   = '莎伶有限公司';
