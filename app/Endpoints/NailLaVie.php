...
class NailLaVie extends HtmlParser
{
    const URL    = 'https://naillavie.shop2000.com.tw';
    const URI    = 'https://naillavie.shop2000.com.tw/product/kw={search_text}';
    const METHOD = 'GET';
    const NAME   = 'Nail La Vie 美甲小舖【美甲材料批發】';
